...
import Movie from '../../ui/containers/Movie.js';
    ...
    render(
      <Router history={ browserHistory }>
          <Route path="/" component={ App }>
              <IndexRoute name="index" component={ Index } onEnter={ track }/>
              <Route name="movie" path="/movie/:_id" component={ Movie } onEnter={ track }/>
